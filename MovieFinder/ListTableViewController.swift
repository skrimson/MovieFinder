...
class ListTableViewController: UITableViewController {
    ...
    var madmax = Movies(name: "マッドマックス： 怒りのデスロード", poster: UIImage(named: "mad_max_p.jpg")!, wall: UIImage(named: "mad_max_w.jpg")!, keys: ["怒", "キレ", "きれ", "ハッチャケ", "はっちゃけ", "ストレス", "眠い", "あああ", "おこ"], comment: "”荒野でクレイジーなひと旅を”", amazon: "http://amzn.asia/ja0SqGr")
    ...
    var leon = Movies(name: "レオン", poster: UIImage(named: "leon_p.jpeg")!, wall: UIImage(named: "leon_w.jpg")!, keys: ["泣", "暇", "おしゃれ", "ひま"], comment: "”MA-1、チョーカーブームはここから？”", amazon: "http://amzn.asia/90zo5Pa")
    ...
    var kingsman = Movies(name: "キングスマン", poster: UIImage(named: "kingsman_p.jpg")!, wall: UIImage(named: "kingsman_w.jpg")!, keys: ["ハッチャケ", "はっちゃけ", "暴", "眠い", "楽", "キレ", "きれ", "あああ"], comment: "”007クレイジー版”", amazon:"http://amzn.asia/6yPQ93u")
    ...
    var drive = Movies(name: "ドライヴ", poster: UIImage(named: "drive_p.jpg")!, wall: UIImage(named: "drive_w.jpg")!, keys: ["憂鬱", "何も", "暇", "ひま"], comment: "”メランコリックながらも魅かれる”", amazon: "http://amzn.asia/bYseSxV")
    ...
    var click = Movies(name: "もしも昨日が選べたら", poster: UIImage(named: "click_p.jpg")!, wall: UIImage(named: "click_w.jpg")!, keys: ["笑", "泣きたい", "何も", "涙", "楽", "悲"], comment: "”笑って泣きたいならばこれを”", amazon: "http://amzn.asia/4KwOOgO")
    ...
    var longest = Movies(name: "ロンゲストヤード", poster: UIImage(named: "longest_p.jpg")!, wall: UIImage(named: "longest_w.jpg")!, keys: ["笑", "運動", "スポーツ", "楽", "キレ", "きれ", "だるい"], comment: "”刑務所で生まれる絆と笑い”", amazon: "http://amzn.asia/6XVAqW9")
    ...
    var deadpool = Movies(name: "デッドプール", poster: UIImage(named: "deadpool_p.jpg")!, wall: UIImage(named: "deadpool_w.jpg")!, keys: ["刺激", "暴", "はっちゃけ", "ひま", "暇", "うんち", "うんこ", "キレ", "きれ", "あああ"], comment: "”ふざけすぎ笑笑”", amazon: "http://amzn.asia/0J7X5eb")
    ...
    var shawshank = Movies(name: "ショーシャンクの空に", poster: UIImage(named: "shawshank_p.jpg")!, wall: UIImage(named: "shawshank_w.jpg")!, keys: ["ひま", "暇", "泣", "悲"], comment: "”感動しかしない”", amazon: "http://amzn.asia/i7lsOpx")
